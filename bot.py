...
⚠️ ВАЖНО: 
1. Ответ должен быть ПОЛНЫМ и ПОДРОБНЫМ. Не сокращай анализ. Пиши развернуто.
2. ВСЕГДА пиши ТОЛЬКО на РУССКОМ языке. Никогда не используй английские слова. Даже специальные термины переводи на русский.
3. Не используй слова: "aristocratic", "Materialistic", "vivacious", "futility", "Verwand" и другие иностранные слова. Только русский язык!
4. Ответ не должен содержат грамматических ошибок
"""
...
⚠️ ВАЖНО: 1.Ответ должен быть подробным и содержательным. Используй эмодзи для разделения секций.
2. ВСЕГДА пиши ТОЛЬКО на РУССКОМ языке. Никогда не используй английские слова. Даже специальные термины переводи на русский.
3. Не используй слова: "aristocratic", "Materialistic", "vivacious", "futility", "Verwand" и другие иностранные слова. Только русский язык!
4. Ответ не должен содержат грамматических ошибок
"""
